...
clim.regimes <- data.frame(year=1950:2019, probability=kk$data$median)
...
biol.regimes <- data.frame(year=1972:2017, probability=kk$data$median)

biol.regimes$data.set <- "Biology 1972-2017"
...
ichthyo.regimes <- data.frame(year=plot.trend$year, probability=kk$data$median)

ichthyo.regimes$data.set <- "Ichthyoplankton 1980-2015"
...
zoop.regimes <- data.frame(year=plot.trend$year, probability=kk$data$median)

zoop.regimes$data.set <- "Zooplankton 1997-2016"
