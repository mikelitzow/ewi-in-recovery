...
prop1 <- apply(loadings.1, 2, f)
prop1
keep <- prop1 > 0.90 # changing to 0.90 threshold!
...
```{r, echo=F}
all <- readRDS("all_plankton_11.20.19.one.trend.rds") 
all$summary
```
...
```{r}
png("combined all plankton time series plots.png", 8, 2.5, units="in", res=300)

ggpubr::ggarrange(plot.a, plot.b, plot.c,
          ncol=3, widths=c(1, 1, 0.8), nrow=1)
