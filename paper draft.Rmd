...
print(plot_loadings(rotated, names = new.names, threshold=0.8))
dev.off()
...
```{r, echo=F}
GOA.biol <- readRDS("/Users/MikeLitzow/Documents/R/Fate/fate-ewi/GOA_biol_5.15.18.rds") 
GOA.biol$summary
```
...
new.names <- c("Chignik.coho", "Chignik.pink", "Chiniak.eulachon", "Chiniak.jellyfish", "Chiniak.shrimp", "Cook.Inlet.coho", "Kodiak.coho", "Kodiak.pink", "Pavlof.capelin", "Pavlof.eulachon", "Pavlof.jellyfish", "Pavlof.shrimp", "Prince.William.coho", "Prince.William.pink", "Southeast.coho", "Southeast.herring", "Southeast.pink", "South.Peninsula.coho", "South.Peninsula.pink")
